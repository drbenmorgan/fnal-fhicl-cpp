...
/*
 * Test case activates the snippet mode; it must be the fist test case in this test suite
 */
...
/*
 * Test case checks if the resolving of @local::-style references can be turned off
 */
...
/*
 * Test case checks if the resolving of @table::-style references can be turned off
 */
...
/*
 * Test case checks if the resolving of @sequence::-style references can be turned off
 */
BOOST_AUTO_TEST_CASE ( keep_unresolved_references_05 )
{
  ...
  sequence_t seq = sss;
  BOOST_CHECK(boost::any_cast<std::string>(seq.at(0).value) =="\"@sequence::ss\"");
}
...
/*
 * Test case checks if the "@nil" values are not affected by the parsing shim code
 */
