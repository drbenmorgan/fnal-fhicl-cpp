...
namespace {
  ...
  struct ThreeNumbers {
    int i_, j_, k_;
    ThreeNumbers(int i, int j, int k)
      : i_{i}, j_{j}, k_{k}
    {}
  };
  ...
  struct Config {
    TupleAs< ThreeNumbers(int,int,int) > tn1 { Name("numbers1"), Comment("Vector for Geant") };
    TupleAs< ThreeNumbers(int,int,int) > tn2 { Name("numbers2"), ThreeNumbers{1,3,5} };
