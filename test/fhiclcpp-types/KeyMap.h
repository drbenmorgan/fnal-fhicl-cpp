#ifndef test_fhiclcpp_types_KeyMap_h
#define test_fhiclcpp_types_KeyMap_h
...
namespace fhicl {
  ...
  class KeyMap : public detail::ParameterWalker<tt::const_flavor::require_const> {
  public:
    auto const& result() const { return keys_; };
