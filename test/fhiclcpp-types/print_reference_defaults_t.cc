...
namespace {
  ...
  struct PSet2 {
    ...
    Sequence<int> sequence { Name("sequence"), Comment("Just to see if this works"), {1,3,67,5} };
  ...
  struct Configuration {
    ...
    Tuple<double,std::string> pair { Name("pair"),     {2.2345678, "Finally, I know what I'm doing."} };
    Tuple<int,std::string,double> tup { Name("tuple"), {5,"some string",16. } };

    Sequence< Tuple<int,double> >    vt { Name("vecOfTuples")  , { {3,27.} } };
    Sequence< Tuple<int,double>, 2 > at { Name("arrayOfTuples"), { {4,15.}, {2,17.} }  };
    ...
    Tuple< Sequence<double>, bool, int>   tv { Name("tupleWithVec")  , { {4.2,7.3},false, 5} };
    Tuple< Sequence<double,2>, bool, int> ta { Name("tupleWithArray"), { {3.6,5.3},false, 5} };
    Tuple< Tuple<int,double>, bool, int>  tt { Name("tupleWithTuple"), { {4,5.9}  , true, 8} };

    Table<PSet2> pset2 { Name("pset2"), Comment("This should work now\ndouble line even.") };
  };
